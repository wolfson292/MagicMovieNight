...
/// watched never reaches the prompt in the first place — unless they have asked for
/// rewatches, in which case the exclusions are lifted entirely.
/// </summary>
public static class CandidateFilter
{
        ...
        int maxCandidates)
    {
        return candidates
            ...
            // Exclusions are skipped wholesale when a rewatch is explicitly wanted.
            .Where(c => request.IncludeAlreadyWatched || !excludedMediaItemIds.Contains(c.Item.Id))
